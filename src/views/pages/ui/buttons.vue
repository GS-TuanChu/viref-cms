      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title-desc">
              Add
              <code>.btn-soft-*</code> class with <code>.btn-*</code> color
              button for a Soft background buttons.
            </p>
            <div class="button-items">
              <b-button variant="primary" class="btn-soft-primary"
                >Primary</b-button
              >
              <b-button variant="success" class="btn-soft-success"
                >Success</b-button
              >
              <b-button variant="info" class="btn-soft-info">Info</b-button>
              <b-button variant="warning" class="btn-soft-warning"
                >Warning</b-button
              >
              <b-button variant="danger" class="btn-soft-danger"
                >Danger</b-button
              >
              <b-button variant="dark" class="btn-soft-dark">Dark</b-button>
              <b-button variant="secondary" class="btn-soft-secondary"
                >Secondary</b-button
              >
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="button-items">
              ...
              <b-button variant="danger" class="w-sm ms-1">Small</b-button>
              <b-button variant="warning" class="w-md ms-1">Medium</b-button>
